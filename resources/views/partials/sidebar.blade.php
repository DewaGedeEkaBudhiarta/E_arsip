...
<aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">         
         <h1 class="text-2xl font-bold p-2">Hello {{ $currentUser->name }}´◡`</h1>
         <li>
         ...
         <li>
            <a href="/arsip-pasi" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Daftar Arsip</span>
            </a>
         </li>         
         <li>
            <a href="{{ route('informasi-arsip.index') }}" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
               ...
               <span class="ms-3">Klasifikasi Arsip</span>
            </a>
            <a href="/activity-logs" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
         ...
         <li>
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Pemindahan Arsip</span>
            ...
            <div id="dropdown" class="hidden z-10 w-44 bg-white rounded-lg shadow-md dark:bg-gray-800">
               <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                  <li>
                     <a href="/pemindahan/table-active" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 ">
                        <span class="ms-3">Arsip Aktif</span>
                     </a>
                  </li>
                  <li>
                     <a href="/pemindahan/table-inactive" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <span class="ms-3">Arsip Inaktif</span>

                     </a>
                  </li>
                  <li>
                     <a href="/pemindahan/tabel-usul-musnah" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <span class="ms-3">Usul Musnah</span>
                     </a>
                  </li>
               </ul>
            </div>
         ...
         <li>
            {{-- log out need to use form because in web.php need to use "POST" function --}}
            <!-- Logout Link -->
