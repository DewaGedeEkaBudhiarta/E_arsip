      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="informasi" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
               ...
               <span class="ms-3">Informasi Arsip</span>
            </a>
         ...
         <li>
            <a href="/pemindahan" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512">
            ...
            <!-- kami akan kembali dengan hidden spacetoon -->
            <ul class="">
               <li>
