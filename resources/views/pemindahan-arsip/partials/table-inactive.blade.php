<div class="container mx-auto p-4">
    ...
    <div class="container mx-auto p-4">
        ...
        <div class="flex items-center mb-4">
            <input type="text" id="search-input" class="ml-2 w-full pl-10 text-sm text-gray-700 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Cari Arsip Inactive">
        </div>
